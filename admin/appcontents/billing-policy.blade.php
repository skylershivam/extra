...
<!-- Theme JS files -->
	...
	<!-- Summernote click to edit -->
		<div class="panel panel-flat">
		    <div class="panel-heading">
							<h5 class="panel-title">Billing & Policy</h5>
	...
	@endif
			<div class="panel-body">
				...
				<form id="form" action="{{url('admin/billing-policy')}}" method="post">	
				<textarea name="billing_policy" class="click2edit" rows="10" cols="80">

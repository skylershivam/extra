...
@section('title', 'View Swap Product')
@section('content')
		...
		<div class="panel panel-flat form-horizontal">
             ...
             <div class="panel-body">
                ...
                <div class="text-right">
					<button type="submit" class="btn btn-primary"> <a style="color:white;" href="{{url('admin/swap-list')}}">Back </a><i class="icon-arrow-right14 position-right"></i></button>
				</div>

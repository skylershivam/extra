			...
			<div class="panel-body">
				...
				<div class="form-group ">
					...
					<select class="bootstrap-select"  id="ddlFruits">
						...
						<option value="monthly" {{request()->is('admin/dashboard-newlistmonthly') ? 'selected' : ''}} >Monthly</option>
                        <option value="yearly" {{request()->is('admin/dashboard-newlistyearly/*') ? 'selected' : ''}} >Yearly</option>
					</select>
                            ...
                            <div class="bg-light p-20">
                                <div class="d-flex">
                                    <div class="align-self-center">
                                        <h3 class="m-b-0">Latest Listings</h3><small></small></div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover earning-box">
                                        ...
                                        <tr>
                                            <td>{{$latest_user->product_name}}</td>
                                            <td>
                                            ...
                                            <td>{{$latest_user->maincategoryname}}</td>
                                            <td>{{$latest_user->subcategory}}</td>
                                            <td>{{$latest_user->sale_price}}</td>
                                        </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
 	...
 	$("#ddlFruits").change(function () {
       ...
       // alert(selectedValue);
        if(selectedValue == 'monthly'){
        	window.location.href = "{{url('admin/dashboard-newlistmonthly')}}";
    	}else if(selectedValue == 'yearly'){
            var selectedValue = '2019'
            window.location.href = "{{url('admin/dashboard-newlistyearly/')}}"+'/'+selectedValue;    
        }else{ 
            window.location.href = "{{url('admin/list-report')}}";
        }

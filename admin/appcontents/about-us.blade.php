...
<div class="content-wrapper">
				...
				<div class="content">
					<!-- Horizontal form options -->
							<!-- Basic layout-->
							<form action="{{url('admin/terms-and-conditions')}}" class="form-horizontal" enctype="multipart/form-data" method="post">
								<div class="panel panel-flat">
                        			<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-lg-3 control-label">Terms&Condition:</label>
											<div class="col-lg-9">
												
											   <textarea id="textarea" rows="30" cols="150" name="terms_and_conditions">

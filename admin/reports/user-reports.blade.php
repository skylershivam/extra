	...
	<div class="content">
		...
		<div class="panel panel-flat">
				...
				<?php //echo $report->reportBy->name; die();  ?>
					<tr>
						<td>{{$i++}}</td>
						<td>{{$report->reportBy->name}}</td>
						<td>{{$report->reportTo->name}}</td>
						<!-- <td><?php echo strlen($report->message) > 20 ? substr($report->message,0,20)."..." : $report->message; ?></td> -->

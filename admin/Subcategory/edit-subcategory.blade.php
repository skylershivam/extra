...
<div class="content-wrapper">
				...
				<div class="content">
					<!-- Horizontal form options -->
							<!-- Basic layout-->
							<form action="{{url('admin/edit-subcategory'.'/'.$category->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post">
								<div class="panel panel-flat">
                        			<div class="panel-body">
									<div class="form-group">
											<label class="col-lg-3 control-label">Main Category:</label>
											<div class="col-lg-9">
											<input type="text"   value="{{$category->maincategoryname}}" class="form-control" readonly>

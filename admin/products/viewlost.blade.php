...
@section('title', 'View Lost Product')
@section('content')
	...
	<div class="page-header page-header-default">
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li class="active">View Lost Product</li>
			</ul>
		</div>
	</div>
	<!-- /page header -->
		...
		<div class="panel panel-flat form-horizontal">
             ...
             <div class="panel-body">
                ...
                <div class="text-right">
					<button type="submit" class="btn btn-primary"> <a style="color:white;" href="{{url('admin/lost-list')}}">Back </a><i class="icon-arrow-right14 position-right"></i></button>
				</div>

	...
	<div class="page-header page-header-default">
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li class="active">View For Sale  Product</li>
			</ul>
		</div>
	</div>
	<!-- /page header -->
             ...
             <div class="panel-body">
                ...
                <div class="form-group">
					...
					<div class="col-lg-9">
                        ...
                        <textarea name = "description"   rows="10" cols="50" class="form-control" readonly>{{$products->description}}</textarea>
					</div>                
				</div>
                ...
                <div class="text-right">
					<button type="submit" class="btn btn-primary"> <a style="color:white;" href="{{url('admin/forsale-list')}}">Back </a><i class="icon-arrow-right14 position-right"></i></button>
				</div>

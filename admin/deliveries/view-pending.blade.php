		...
		<div class="panel panel-flat form-horizontal">
			<div class="col-lg-12">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" name="email" value="{{$delivery->order->product->product_name}}" class="form-control" readonly>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" name="email" value="{{$delivery->order->amount}}" class="form-control" readonly>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" name="email" value="{{$delivery->source_address}}" class="form-control" readonly>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" name="email" value="{{$delivery->destination_address}}" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">

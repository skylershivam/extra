...
<div class="content-wrapper">
	...
	<!-- Content area -->
	<div class="content">
    <button type="button" onclick="window.location.href='{{url('admin/add-wanted')}}'" class="btn btn-primary" style="margin-bottom:20px;">Add Product</button>
							...
							<ul class="icons-list">  
								<li class="dropdown">	
									...
									<ul class="dropdown-menu dropdown-menu-right">
										...
										<li><a href="{{url('admin/view-wanted'.'/'.$product->id)}}"><i class="icon-eye"></i>View</a></li>
										<li><a href="{{url('admin/delete-wanted'.'/'.$product->id)}}"><i class="icon-folder-remove"></i>Delete</a></li>
										<li><a href="{{url('admin/edit-wanted'.'/'.$product->id)}}"><i class="icon-pencil5"></i>Edit</a></li>

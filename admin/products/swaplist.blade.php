...
<div class="content-wrapper">
	...
	<div class="page-header page-header-default">
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li class="active">Add Swap Prouct</li>
			</ul>
   		</div>
	</div>
	...
	<!-- Content area -->
	<div class="content">
    <button type="button" onclick="window.location.href='{{url('admin/add-swap')}}'" class="btn btn-primary" style="margin-bottom:20px;">Add Product</button>
							...
							<ul class="icons-list">  
								<li class="dropdown">	
									...
									<ul class="dropdown-menu dropdown-menu-right">
										...
										<li><a href="{{url('admin/view-swap'.'/'.$product->id)}}"><i class="icon-eye"></i>View</a></li>
										<li><a href="{{url('admin/delete-swap'.'/'.$product->id)}}"><i class="icon-folder-remove"></i>Delete</a></li>
										<li><a href="{{url('admin/edit-swap'.'/'.$product->id)}}"><i class="icon-pencil5"></i>Edit</a></li>

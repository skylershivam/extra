...
@section('title', 'Edit Lost Product')
@section('content')
...
<div class="content-wrapper">
	...
	<div class="page-header page-header-default">
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li class="active">Lost Edit Product</li>
			</ul>
		</div>
	</div>
	<!-- /page header -->
    ...
    <form action="{{url('admin/edit-lost'.'/'.$products->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post">
    @csrf
    <div class="content">

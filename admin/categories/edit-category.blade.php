...
@section('title', 'Edit Listing Category')
@section('content')
<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Edit Listing Category</li>
						</ul>
					</div>
				</div>
				<!-- /page header -->
				...
				<div class="content">
					<!-- Horizontal form options -->
							<!-- Basic layout-->
							<form action="{{url('admin/edit-category'.'/'.$category->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post">
								<div class="panel panel-flat">
                        			<div class="panel-body">
										<div class="form-group">
											<label class="col-lg-3 control-label">Listing Category:</label>
											<div class="col-lg-9">

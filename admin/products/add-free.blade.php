...
@section('title', 'Add Free Product')
@section('content')
	...
	<div class="page-header page-header-default">
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li class="active"> Add free Product</li>
			</ul>
		</div>
	</div>
	<!-- /page header -->
	<!-- Content area -->
	<form action="{{url('admin/storeFree')}}" class="form-horizontal" enctype="multipart/form-data" method="post">
    @csrf
    <div class="content">
